...
@section('content')
    ...
    <style>
        table tr{
            ...
            $mahasiswa = \DB::select('SELECT StudentID,Nama,kode_krs,kode_term,kode_matakuliah,nama_matakuliah,sks,total_sks FROM vmhskrs')[0];
            echo "Nama : ".$mahasiswa->Nama."<br>";
            echo "Student ID : ".$mahasiswa->StudentID."<br>";
            echo "Total Sks : ".$mahasiswa->total_sks."<br><br>";
